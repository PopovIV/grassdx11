...
void Skybox::draw(XMMATRIX const& worldMatrix) {
	...
	// Update shader
	this->shader.update(renderer, XMMatrixScaling(2000.0f, 2000.0f, 2000.0f) * XMMatrixTranslation(0.0f, 200.0f, 0.0f) * XMMatrixRotationY(250.0f) * worldMatrix);
